...
public class QuestionnaireData implements Parcelable {
    ...
    protected QuestionnaireData(Parcel in) {
        if (in.readByte() == 0) {
            longitude = null;
        } else {
    ...
    public static final Creator<QuestionnaireData> CREATOR = new Creator<QuestionnaireData>() {
        @Override
        public QuestionnaireData createFromParcel(Parcel in) {
            return new QuestionnaireData(in);
        }

        @Override
        public QuestionnaireData[] newArray(int size) {
            return new QuestionnaireData[size];
        }
    };
